...
<p>
   <!--  <button onclick="setCenter()">지도 중심좌표 이동시키기</button> 
    ...
    <button class="btn" onclick="panTo1()">기흥도서관</button>
    <button class="btn" onclick="panTo2()">송파도서관</button>
    <button class="btn" onclick="panTo3()">장안도서관</button>
    <button class="btn" onclick="panTo4()">분당도서관</button>
</p>
