...
<div id="divContentsW">
	<div id="divContents">
		...
		<div id="divLocation">
			<ul>
				<li class="home"><a href="${pageContext.request.contextPath}/index.jsp?library=${library}&ln=${ln}"><img src="${pageContext.request.contextPath }/image/common/home.png" alt="HOME"></a></li>
				<li>&gt;</li>
				<li>찾아오시는길</li>
			</ul>
		</div>
